...
EXP_NAME = "fetch_push_dense_v0_cleanrl_sac_her_seed"
ALGORITHM = "sac"
CONTROL_TYPE = None
...
def get_candidate() -> str:
    return (
        "CleanRL-style SAC+HER seed for FetchPushDense-v4. Uses the same "
        "goal-observation flattening and SAC update as the default seed, but "
        "relabels a configurable fraction of replay samples with achieved goals "
        "and recomputed task rewards. Warmup, relabel fraction, batch size, and "
        "update cadence are intentionally editable in this file."
    )
